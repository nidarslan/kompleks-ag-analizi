...
#yakınlık ve aradalık ölçütleri ile ayrı ayrı belirleyip yönlü üçer graf üzerinde
...
x1= nx.lollipop_graph(100,5)
x2=nx.barabasi_albert_graph(100,1)
x3= nx.barbell_graph(50,2)

#Grafları yönlü grafa çevirdik.
G1=nx.to_directed(x1)
G2=nx.to_directed(x2)
G3=nx.to_directed(x3)
